...
header: 
  ...
  overlay_filter: 0.5
excerpt: "This report forecasts future co-morbidity prevalence and dependency of older people from 2022 to 2035 by applying findings from a UK study to the local population. The pdf version includes charts and tables which are not included in the Microsoft Word version which has been adapted to be as accessible as possible."
category: JSNA
