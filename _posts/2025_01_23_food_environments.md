---
layout: single
title: "Food Environments Briefing"
date: 2026-01-23
header: 
  overlay_color: "#1976d2"
  overlay_filter: 0.5
excerpt: "A briefing which provides a summary of the retail food environment in West Sussex, using data from the Food Standards Agency’s (FSA) Food Hygiene Rating Scheme"
toc: false
...
+ West Sussex has the fifth lowest number of fast-food outlets per 100,000 when compared to its nearest statistical neighbours (local authorities that are deemed to have similar social‐economic characteristics).
