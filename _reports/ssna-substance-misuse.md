...
+ Community Fund Co-Production Programme Evaluation (2026)
...
This evaluation summary report details the West Sussex Drug and Alcohol Partnership Community Fund Co-Production Programme, which was designed and delivered from Spring 2024 to Spring 2026, directed by members of the Public Health team, and managed by the community organisation CAPITAL. The report is structured to provide the context, rationale and outcomes of the programme, and provides valuable insights for the applicability and viability for community-based co-development of community fund programmes, with particular reference to Lived and Living Experience of substance use and multiple compound needs. 

Core audiences include West Sussex Drug and Alcohol Partnership members, OHID leads, Public Health departments and Local Authorities and all other interested in developing meaningful co-production programmes in their local community. 

## Downloads

[Report (PDF, 1.5Mb)](/assets/pdf/dap/WS_DAP_Community_Fund_programme_-_Evaluation_2026.pdf)
