...
var color_pcn_group = d3.scaleOrdinal()
    ...
    request.open("GET", '/assets/js/pcn_overview.json', false);
    request.send(null);
...
var request = new XMLHttpRequest();
request.open("GET", '/assets/js/gp_lookup_pcn_overview.json', false);
request.send(null);
...
var pcn = $.ajax({
  url:"/assets/js/pcn_simple.geojson",
  dataType: "json",
...
// Add AJAX request for data
var lad = $.ajax({
  url:"/assets/js/lad_simple.geojson",
  dataType: "json",
