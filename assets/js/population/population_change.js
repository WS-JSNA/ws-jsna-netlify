...
var request = new XMLHttpRequest();
    request.open("GET", "/assets/js/population/area_components_of_change_df.json", false);
    request.send(null);
...
var request = new XMLHttpRequest();
    request.open("GET", "/assets/js/population/wsx_2018_pop.json", false);
    request.send(null);
...
var request = new XMLHttpRequest();
    request.open("GET", "/assets/js/population/area_change_over_time_df.json", false);
    request.send(null);
...
// Population pyramid
var request = new XMLHttpRequest();
    request.open("GET", "/assets/js/population/area_population_quinary_df_v2.json", false);
    request.send(null);
...
tooltip_pyramid_1_male
  .html("<h4>" + d.Age_group + '</h4><p class = "side">The estimated number of males aged ' + d.Age_group + ' in ' + d.Year + ' was ' + d3.format(",.0f")(d.Male_Population) + '. This is ' + d3.format('.1%')(d.Male_Percentage) + ' of the population of males in ' + d.Area_Name + '.</p><p class = "side">The total population in ' + d.Area_Name + ' in ' + d.Year + ' is ' + d3.format(',.0f')(totalPopulation) + '</p>')
  .style("opacity", 1)
...
// Median age data
var request = new XMLHttpRequest();
    request.open("GET", "/assets/js/population/area_median_age_df.json", false);
    request.send(null);
